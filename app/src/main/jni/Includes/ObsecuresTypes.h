...
/*
int GetObscuredInt(uint32_t location){
...
int GetObscuredInt64bit(uint64_t location){
	int cryptoKey = *(int *)location;
    int encryptedValue = *(int *)(location + 0x4);
	int realValue = encryptedValue ^ cryptoKey;
    return realValue;
...
void SetObscuredInt(uint32_t location, int value){
    int cryptoKey = *(int *)location;
	int encryptedValue = value ^ cryptoKey;
    *(int *)(location + 0x4) = encryptedValue;
}

void SetObscuredInt64bit(uint64_t location, int value){
    int cryptoKey = *(int *)location;
	int encryptedValue = value ^ cryptoKey;
    *(int *)(location + 0x4) = encryptedValue;
}

float GetObscuredFloat(uint32_t location){
    int cryptoKey = *(int *)location;
...
float GetObscuredFloat64bit(uint64_t location){
    int cryptoKey = *(int *)location;
	intfloat encryptedValue;
	encryptedValue.f = *(float *)(location + 0x4);
	intfloat realValue;
...
void SetObscuredFloat(uint32_t location, float value){
    int cryptoKey = *(int *)location;
    intfloat realValue;
    realValue.f = value;
    intfloat encryptedValue;
...
void SetObscuredFloat64bit(uint64_t location, float value){
    int cryptoKey = *(int *)location;
    intfloat realValue;
    realValue.f = value;
    intfloat encryptedValue;
